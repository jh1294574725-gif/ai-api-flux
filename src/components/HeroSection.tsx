...
const HeroSection = () => {
  return (
    <section className="relative min-h-[85vh] md:min-h-[90vh] flex items-center justify-center overflow-hidden">
      {/* Animated mesh blobs */}
      <div className="absolute top-10 md:top-20 -left-20 md:-left-32 w-[300px] md:w-[500px] h-[300px] md:h-[500px] bg-primary/[0.07] animate-blob blur-[60px] md:blur-[80px]" />
      <div className="absolute top-20 md:top-40 -right-10 md:right-0 w-[250px] md:w-[400px] h-[250px] md:h-[400px] bg-secondary/[0.06] animate-blob blur-[60px] md:blur-[80px]" style={{ animationDelay: "2s" }} />
      <div className="absolute -bottom-10 md:-bottom-20 left-1/4 md:left-1/3 w-[280px] md:w-[450px] h-[280px] md:h-[450px] bg-accent/[0.05] animate-blob blur-[60px] md:blur-[80px]" style={{ animationDelay: "4s" }} />
      ...
      <div className="container relative z-10 text-center px-4 sm:px-6">
        ...
        <motion.div
          ...
          className="mt-14 md:mt-20 grid grid-cols-2 md:grid-cols-4 gap-6 md:gap-8 max-w-3xl mx-auto"
        >
          {[
